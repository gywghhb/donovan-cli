...
SLASH_COMMANDS = [
    ...
    "/browser companion setup chrome",
    "/browser companion setup edge",
    "/browser companion setup brave",
    "/browser companion setup vivaldi",
    "/browser companion setup opera",
    "/browser companion setup arc",
    "/browser companion setup firefox",
    "/browser companion start",
    "/browser companion status",
    "/browser companion active",
    "/browser companion snapshot",
    "/browser companion tabs",
    "/browser companion use",
    ...
    "/doctor-ai",
    "/workspace-profile",
    "/workspace-profile create",
    "/workspace-profile switch",
    "/agent-test",
    "/agent-test create",
    "/agent-test run",
    # MCP commands
